...
if(validarSessao() && ($_SESSION['funcao']==1 || $_SESSION['funcao']==3 || $_SESSION['funcao']==4)){
    try{
        ...
        isset($_POST['status'])&&
        isset($_POST['vagas'])&&
        isset($_POST['datainicioinscricoes'])&&
        isset($_POST['datafiminscricoes'])){
            ...
            $vardatainicioinscricoes = $_POST['datainicioinscricoes'];
            $vardatafiminscricoes = $_POST['datafiminscricoes'];
            ...
            '$vardatainicioinscricoes','$vardatafiminscricoes')";
            $conn->exec($sql);
