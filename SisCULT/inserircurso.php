...
if(validarSessao() && $_SESSION['funcao']<>5 || $_SESSION['funcao']==1){
    try{
        ...
        isset($_POST['coordenador'])){
            ...
            //inserir na tabela
            $sql="insert into tbcursos 
            (nome,nivel,faixaetariaminima,faixaetariamaxima,status,idCoordenador)
            values 
            (:nome,:nivel,:faixaetariaminima,:faixaetariamaxima,:status,:coordenador)";
